...
variableStorage: function(data, varType) {
	...
	return ([data.varName2, 'Collection']);
},
...
fields: ["storage", "varName", "filter", "max", "time","varName2", "storage2", "iftrue", "iftrueVal", "iffalse", "iffalseVal"],
...
html: function(isEvent, data) {
	...
	<div style="width: 75%; margin-top: 8px;">
		 Filter Eval:<br>
		 <input id="filter" class="round" type="text" value="content == 'response'" placeholder="e.g. content == 'YourAwaitAnswer'">
	</div>
	<br>
...
<div style="padding-top: 8px;">
 ...
 <div>
 <div style="float: left; width: 35%;">
	 Store Message Collection In: (Use List and Loops)<br>
...
action: function(cache) {
	...
	if(channel) {
		...
		channel.awaitMessages(function(msg) {
			...
			this.storeValue(collected, storage2, varName2, cache);	
